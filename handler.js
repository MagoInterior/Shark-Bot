...
this.sendButton(id, wm, text, apii.data, [[(action == 'add' ? lenguajeGB.smsCont13() : lenguajeGB.smsCont14()), (action == 'add' ? '.s' : '.s')], ['👹 𝙄𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪', `.menu`]], null, {mentions: this.parseMention(text)})
//this.sendHydrated(id, text, groupMetadata.subject, apii.data, 'https://github.com/GyutaroNc/Shark-Bot', '𝐒𝐡𝐚𝐫𝐤-𝐁𝐨𝐭ㅤ🦈', null, null, [
//[(action == 'add' ? '𝙎𝙚 𝙪𝙣𝙞𝙤 🥳!!' : '𝙎𝙚 𝙛𝙪𝙚 𝙪𝙣 𝙍𝙖𝙣𝙙𝙤𝙢 🧐'), '.s'], ['👾 𝙄𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪', '/menu']], '', { mentions: [user]})
}}}
