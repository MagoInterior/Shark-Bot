...
const smsRowner = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡ESTE COMANDO SÓLO YO COMO CREADOR DEL BOT LO PUEDE USAR!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡ESTE COMANDO SÓLO MI CREADOR LO PUEDE USAR!!\`\`\`` }//OWNER
const smsMods = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡ESTE COMANDO SÓLO MODERADORES Y MI CREADOR LO PUEDEN USAR!!\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡ESTE COMANDO SÓLO ESTA DISPONIBLE PARA USUARIOS PREMIUM Y MI CREADOR!!\`\`\`` }//USUARIOS PREMIUM
...
const smsRestrict = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADOR!!\`\`\`` }//RESTRINGIR COMANDO
...
//_allantilink.js
const smsTextoYT = () => { return '𝐒𝐡𝐚𝐫𝐤-𝐁𝐨𝐭ㅤ🦈- 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} //🟡 NO CAMBIAR 
...
const smsEnlaceIg = () => { return `𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙄𝙉𝙎𝙏𝘼𝙂??𝘼𝙈 𝙀𝙉 𝙀??𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar el Shark-Bot`}
