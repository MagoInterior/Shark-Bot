...
//global.enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝗦𝘂𝗽𝗲𝗿 𝙎𝙃𝘼𝙍𝙆𝘽𝙊𝙏', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
