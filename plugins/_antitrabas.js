...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "50582783643-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": '𝙎𝙃𝘼𝙍𝙆𝘽𝙊𝙏', 'jpegThumbnail': null}}}
