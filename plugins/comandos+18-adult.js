...
let res = (await axios.get(`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/nsfwass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
...
let res = (await axios.get(`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/nsfwbdsm.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
...
let res = (await axios.get(`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/nsfwero.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
...
let res = (await axios.get(`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/hentai.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
...
let res = (await axios.get(`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/nsfworgy.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
...
let res = (await axios.get(`https://raw.githubusercontent.com/HasamiAini/wabot_takagisan/main/whatsapp%20bot%20takagisan/whatsapp%20bot%20takagisan/lib/Yaoi.json`)).data  //`https://raw.githubusercontent.com/GyutaroNc/Shark-Bot/master/src/JSON/yaoi.json`
let enlace = await res[Math.floor(res.length * Math.random())]
