...
let Terminos = `
*_Toda la información que se mencione aquí no excluye el Propietario del Bot, y del mal uso que le puedan dar a Shark-Bot_*
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de Shark-Bot. Eso no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._
...
*TÉRMINOS DE USO* 
_- La información que haya en este Bot y el usuario Haga uso de las Mismas asumirá saber los Términos y Condiciones de tal forma que no habrá incovenientes al hacer un uso Particular de las Funciones del Bot._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarán las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de Shark-Bot._


*ESTE ES EL REPOSITORIO OFICIAL*
*https://github.com/GyutaroNc/Shark-Bot*


*CUENTA OFICIAL DE ASISTENCIA - INSTAGRAM*
~ _Solo en esta Cuenta Respondo si tiene Dudas, Preguntas o Necesita Ayuda sobre el Shark-Bot, También puede Comunicarse en Caso de Temas de Colaboración_
*https://www.instagram.com/jose_artl*


*~ Muchas Gracias Por tomarte el tiempo en informate sobre el Shark-Bot*
`.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/jose_artl`, pp, 'https://github.com/GyutaroNc/Shark-Bot', '𝐒𝐡𝐚𝐫𝐤-𝐁𝐨𝐭ㅤ🦈', null, null, [
