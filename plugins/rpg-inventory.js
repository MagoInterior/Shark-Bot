...
┃ *» ${armor == 0 ? 'No tengo' : '' || armor == 1 ? '✦ Armadura de Cuero' : '' || armor == 2 ? '✦ Armadura de Hierro' : '' || armor == 3 ? '✦ Armadura Mágica' : '' || armor == 4 ? '✦ Armadura Robótica' : '' || armor == 5 ? 'Armadura Cyborg Estelar ǁ MAX' : ''}*
┃ ╸╸╸╸╸╸╸╸╸╸╸╸╸╸
┃ 🎣 *Caña de Pescar* 
┃ *» ${fishingrod}* 
╰━━━━━━━━━⬣
...
*╭──┴─────────┄⸙*
*│🦊 Zorro : Fox*
*│* ${rubah == 0 ? '*No tengo*' : '' || rubah > 0 && rubah < 5 ? `*Nivel/Level ${rubah} A Nivel/To Level ${rubah + 1}*\n*│* Exp *${_rubah}* -> *${rubah *100}*` : '' || rubah == 5 ? '*Nivel Máximo : Max Level*' : ''}
*╰──┬─┄*
*╭──┴─────────┄⸙*
*│🐈 Gato : Cat* 
*│* ${kucing == 0 ? '*No tengo*' : '' || kucing > 0 && kucing < 5 ? `*Nivel/Level ${kucing} A Nivel/To Level ${kucing + 1}*\n*│* Exp *${_kucing}* -> *${kucing *100}*` : '' || kucing == 5 ? '*Nivel Máximo : Max Level*' : ''}
*╰──┬─┄*
*╭──┴─────────┄⸙*
*│🐎 Caballo : Horse* 
*│* ${kuda == 0 ? '*No tengo*' : '' || kuda > 0 && kuda < 5 ? `*Nivel/Level ${kuda} A Nivel/To Level ${kuda + 1}*\n*│* Exp *${_kuda}* -> *${kuda *100}*` : '' || kuda == 5 ? '*Nivel Máximo : Max Level*' : ''}
*╰──┬─┄*
*╭──┴─────────┄⸙*
*│🐶 Perro : Dog* 
*│* ${anjing == 0 ? '*No tengo*' : '' || anjing > 0 && anjing < 5 ? `*Nivel/Level ${anjing} A Nivel/To Level ${anjing + 1}*\n*│* Exp *${_anjing}* -> *${anjing *100}*` : '' || anjing == 5 ? '*Nivel Máximo : Max Level*' : ''}
*╰────┄⸙*
...
*│ Poder del Gancho*\n*│ ${pancingan == 0 ? 'No tengo' : '' || pancingan > 0 && pancingan < 5 ? `Nivel » ${pancingan} a Nivel ${pancingan + 1}*\n*│ Exp » ${_pancingan} -> ${pancingan *10000}*` : '' || pancingan == 5 ? 'Nivel ✦ 5 ǁ MAX' : ''}*
*╰────────────────*
...
*╭────────────────*
*│🪝 Gancho : Hook » ${pancingan == 0 ? 'No tengo' : '' || pancingan == 1 ? 'Nivel ✦ 1' : '' || pancingan == 2 ? 'Nivel ✦ 2' : '' || pancingan == 3 ? 'Nivel ✦ 3' : '' || pancingan == 4 ? 'Nivel ✦ 4' : '' || pancingan == 5 ? 'Nivel ✦ 5 ǁ MAX' : ''}*
*│ Poder del Gancho » ${pancingan == 0 ? 'No tengo' : '' || pancingan > 0 && pancingan < 5 ? `Nivel » ${pancingan} a Nivel ${pancingan + 1}*\n*│ Exp » ${_pancingan} -> ${pancingan *10000}*` : '' || pancingan == 5 ? 'Nivel ✦ 5 ǁ MAX' : ''}
*╰────────────────*
