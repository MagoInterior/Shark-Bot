...
'https://i.ibb.co/jGMzqY3/obtenerpremium.jpg',
'https://i.ibb.co/GsMgDYn/sharkpremium.jpg'];
...
*┃*
*┃✨ 𝙉𝙊𝙈𝘽𝙍𝙀 » ${user.name}*
*┃💰 𝙋𝘼𝙂𝙊 »  -${shark * text} ${rpgshopp.emoticon('berlian')}*
...
*┃*
*┃✨ 𝙉𝙊𝙈𝘽𝙍𝙀 » ${user.name}*
*┃💰 𝙋𝘼𝙂𝙊 »  -${shark * text} ${rpgshopp.emoticon('joincount')}*
...
*┃*
*┃✨ 𝙉𝙊𝙈𝘽𝙍𝙀 » ${user.name}*
*┃💰 𝙋𝘼𝙂𝙊 »  -${shark * text} ${rpgshopp.emoticon('diamond')}*
...
*┃*
*┃✨ 𝙉𝙊𝙈𝘽𝙍𝙀 » ${user.name}*
*┃💰 𝙋𝘼𝙂𝙊 »  -${shark * text} ${rpgshopp.emoticon('gold')}*
