...
['💎 𝘾𝙤𝙢𝙥𝙧𝙖 𝘼𝙗𝙨𝙤𝙡𝙪𝙩𝙖', '/buyall3']
    ...
    await conn.sendHydrated(m.chat, `*No tiene sufuciente 𝘿𝙄𝘼𝙈𝘼𝙉𝙏𝙀𝙎 💎 para comprar ${count} 𝙏𝙊𝙆𝙀𝙉(𝙎)* 🪙\n\n*Le recomiendo que interactúe con SharkBot para Obtener Tokens, puede ver sus tokens con el comando ${usedPrefix}cartera o ${usedPrefix}wallet*`, wm, null, ig, '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', null, null, [
